...
<body class="bg-gray-100 font-sans">
    <nav class="bg-blue-600 text-white p-4 px-6 md:px-20">
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            <div class="flex">
                <a href="{{ route('home') }}" class="text-2xl font-bold">My Tools Hub</a>
            </div>
    ...
    <footer class="bg-gray-900 text-gray-400 py-12 mt-16 flex justify-between content-center align-items-center">
        <div class="px-4 text-center">
            <h4 class="text-xl ">Design and Developed By: </h4><br />
            <a class="text-underline text-gray-100" href="mailto:sakhawatalilarik@gmail.com">Sakhawat Ali Larik</a>
            and
            <a class="text-underline text-gray-100" href="mailto:mymonzain@gmail.com">Zain Memon</a>
        </div>
        <div class="px-4 text-center ">
            <h4 class="text-xl">All rights reserved</h4><br />
            <p>&copy; {{ date('Y') }} <a class="text-underline text-gray-100"
                    href="https://mytoolshub.online/">MyToolsHub.online</a>. </p>
        </div>
